...
public abstract class Conta implements IConta {
    ...
    protected String nomePagamento;
    ...
    public void pagar(double valorPagamento, String nomePagamento){

        System.out.println("Voce pagou: " + valorPagamento + " em " + nomePagamento + "\n");
    }
}
